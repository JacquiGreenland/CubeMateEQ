...
// =================================================================================================================================
// CONTROLLER ======================================================================================================================
#define HOST_NAME                "OnStep-Cubemate" // nStep", Hostname for this device up to 16 chars.                                 Adjust
...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE      8888.8889 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_IRUN             775 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE      8888.8889 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_IRUN             775 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
